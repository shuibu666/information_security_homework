...
def main() -> None:
    ...
    for source_id, record in manifest.items():
        score = standard_kgw_score(record["prompt_token_ids"], record["human_completion_token_ids"], len(tokenizer), args.gamma, args.hash_key, args.device, green_mask_cache)
    ...
    for record in generations:
        ...
        score = standard_kgw_score(record["prompt_token_ids"], record["continuation_token_ids"], len(tokenizer), args.gamma, args.hash_key, args.device, green_mask_cache)
